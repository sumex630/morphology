...
def gmm():
    ...
    for i, filename in enumerate(file_names):
        ...
        fgmask_thresh = cv2.threshold(fgmask, 127, 255, cv2.THRESH_BINARY)[1]
        ...
        # 保存
        save_img(fgmask_thresh, save_path_dict[algorithm_type] + '/%s%06d.jpg' % (algorithm_type, i + 1))
...
if __name__ == '__main__':
    ROOTPATH = '../dataset'
    stats_time_path = '../stats_time_gmm.txt'
